...
public class Args {
    ...
    private void setIntArg(char argChar) throws ArgsException { currentArgument++;
        ...
        try {
            ...
            intArgs.put(argChar, Integer.parseInt(parameter)); } catch (ArrayIndexOutOfBoundsException e) {
            valid = false;
    ...
    private void setStringArg(char argChar) throws ArgsException { currentArgument++;
        try {
            stringArgs.put(argChar, args[currentArgument]); } catch (ArrayIndexOutOfBoundsException e) {
            valid = false;
            errorArgumentId = argChar;
